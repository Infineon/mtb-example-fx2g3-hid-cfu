...
/**
 * \name Cy_USB_AppInit
 * \brief This function Initializes application related data structures,
 ...
 * \param pHbDmaMgrCtxt
 * \retval None.
 * \note This function should be called after USBD_Init
 */
void
