...
APPNAME=mtb-example-fx2g3-hid-cfu
...
# Include CFU features with the firmware. Options include:
#
# yes -- Enable HID-CFU capable firmware
# no  -- Disable HID-CFU capable firmware
CFUENABLE ?= yes
...
# Conditionally allow compilation with CFU capabilities if CFUENABLE is set to yes
ifeq ($(CFUENABLE), yes)
	DEFINES += \
                FX_CFU=1 \
                CUSTOM_CFU_SPI=0
