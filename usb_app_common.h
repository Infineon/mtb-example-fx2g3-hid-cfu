...
* \version 1.0
*
* \brief    Provides interface definitions of the functions used to configure USB endpoint
*           and DMA resources.
*
*******************************************************************************
* \copyright
 ...
 * \brief   This Function de-couple endpoint and DMA channel for HS controller. It also
 ...
 * \param pAppCtxt application layer context pointer.
 * \param endpNum endpoint number.
 * \retval TRUE if valid bit is set. FALSE if valid bit is cleared.
 */
